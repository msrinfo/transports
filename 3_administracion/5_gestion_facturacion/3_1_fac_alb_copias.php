...
<input name="cod_factura_fin" type="text" id="cod_factura_fin" size="6" maxlength="6" onBlur="buscar_conta(event,'facturas',cod_factura_fin.value,'cod_factura',cod_factura_fin.value,'cod_empresa',cod_empresa.value,'origen','A','','','','','','','fac_fin');">
  ...
  <tr>
    ...
    <td colspan="5" align="center">
	  ...
	  <input name="gen_pdf" type="button" id="gen_pdf" onClick="facturas_copias_tt(event)" value="Gen. PDF">&nbsp;
      <input name="enviar_mail" type="button" id="enviar_mail" onClick="facturas_copias_tt(event)" value="Enviar E-Mail">&nbsp;
      <input name="pdf_mail" type="button" id="pdf_mail" onClick="facturas_copias_tt(event)" value="Gen. PDF y Enviar E-Mail">&nbsp;
