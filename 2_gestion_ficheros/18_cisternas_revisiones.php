...
$comprobar="SELECT * FROM cisternes WHERE mat1 = '$mat1'";
...
if ($eliminar==2)
{
$eliminar="DELETE FROM cisternes WHERE cod_tractora = '$cod_tractora'";
...
if ($cod_tractora)
{
$mostrar="SELECT * FROM cisternes WHERE cod_tractora = '$cod_tractora'";
...
?>
  ...
  <tr>
    ...
    <td align="right"></td>
    <td>
    <input type="text" name="rem[<? echo $i; ?>][mat1]" id="rem[<? echo $i; ?>][mat1]" value="<? echo $mat1; ?>" size="11"></td>
    <td width="63"><input type="text" name="rem[<? echo $i; ?>][itv]" id="rem[<? echo $i; ?>][itv]"  style="background-color:<? echo $color_itv; ?>" maxlength="10" size="9" value="<? echo fecha_esp($itv); ?>"></td>
    <td width="64"><input type="text" name="rem[<? echo $i; ?>][adr]" id="rem[<? echo $i; ?>][adr]" style="background-color:<? echo $color_adr; ?>" maxlength="10" size="9" value="<? echo fecha_esp($adr); ?>"> </td>
    <td width="76"><input type="text" name="rem[<? echo $i; ?>][tacograf]" id="rem[<? echo $i; ?>][tacograf]" style="background-color:<? echo $color_tacog; ?>" maxlength="10" size="9" value="<? echo fecha_esp($tacograf); ?>"></td>
    ...
    <td width="70"><input type="text" name="rem[<? echo $i; ?>][seguro]" id="rem[<? echo $i; ?>][seguro]" style="background-color:<? echo $color_seg; ?>" maxlength="10" size="9" value="<? echo fecha_esp($seguro); ?>"></td>
    <td width="68"><input type="text" name="rem[<? echo $i; ?>][adr_rev]" id="rem[<? echo $i; ?>][adr_rev]" style="background-color:<? echo $color_adr_rev; ?>" maxlength="10" size="9" value="<? echo fecha_esp($adr_rev); ?>"></td>
    ...
    <td width="133"><input type="text" name="rem[<? echo $i; ?>][mto_rev]" id="rem[<? echo $i; ?>][mto_rev]" style="background-color:<? echo $color_mto_rev; ?>" maxlength="10" size="9" value="<? echo fecha_esp($mto_rev); ?>"></td>
    <td>&nbsp;</td>
    <td colspan="4">&nbsp;</td>
  </tr>
 <?
...
?>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td width="78" align="center"><img src="/comun/imgs/guardar.gif" title="Guardar" onClick="enviar(event);" onMouseOver="window.top.focus();"><br />
Guardar</td>
    <td colspan="2" align="center"><img src="/comun/imgs/nuevo.gif" title="Nou" onClick="location.href=direccion_conta('');"><br />
Nou</td>
    <td colspan="6" align="center"><img src="/comun/imgs/eliminar.gif" title="Eliminar" onClick="eliminar(event,'cod_tractora');"><br />
      Eliminar</td>
    <td width="228"></td>
    <td>&nbsp;</td>
  </tr>
