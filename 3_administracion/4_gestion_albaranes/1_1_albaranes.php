...
// RECONEXION  CON EL SERVER LOCAL:
...
$fiesta=sel_campo("COUNT(fecha_ini)","fecha_ini","op_fiestas","(cod_operario = '$cod_operario' or cod_operario='$cod_operario2') and fecha_ini <= '$fecha_carga' and fecha_fin >= '$fecha_carga'");

if($fiesta>0)
{	
?>
<script type="text/javascript">
alert("Aquest operari té festa aquest dia. No es guardaran els canvis.");
...
// SI TRASPASO ES SI: ENVIAMOS A LA TABLET:
if($traspaso=='si')
{

//echo "ENTRAMOS EN TRASPASO";
...
// SI LO DEJO ASI, AUNQUE EL CHOFER HAYA CONFIRMADO PUEDE VOLVER A ENVIARLE:
$albaranes="SELECT * FROM albaranes WHERE cod_albaran='$cod_albaran'"; //and confirmado!='si'
...
{
$poblacion=addslashes($poblacion);
//echo "<br/><br/>POB:$poblacion";

// INSERTAMOS:
$insertar_ord="INSERT INTO albaranes
(cod_albaran, cod_empresa,fecha,cod_cliente,nombre_cliente,tipo_iva,cod_descarga,poblacion,observ_descarga, horas_descarga, fecha_descarga, fecha_carga,viaje, franja, cod_tarjeta, mat1, cod_tractora, mat2, cod_terminal, nombre_terminal, cod_operadora,nombre_operadora, cod_operario,cod_operario2,
avisador,precio_chof,precio_cli,cod_pedido,cant_blue,cant_sp95,cant_sp98,cant_go_a,
cant_go_a1,cant_go_b,cant_go_c,cant_bio, suma_pedidos, serv_blue, serv_sp95, serv_sp98, serv_go_a, serv_go_a1, serv_go_b, serv_go_c, serv_bio, suma_servidos, cant_comp1, cant_comp2, cant_comp3, cant_comp4, cant_comp5, cant_comp6, cant_comp7, cant_comp8, prod_comp1,	prod_comp2, prod_comp3, prod_comp4, prod_comp5, 
prod_comp6, prod_comp7, prod_comp8, observaciones, incidencias, a_cobrar, base, cambiar_papel,  observ_cambiar_papel, conectar_toma_terra, conectar_man_gasos, treure_mostres, doble_carga, prec_doble_carga_cli, prec_doble_carga_chof, doble_descarga, prec_doble_desc_cli, prec_doble_desc_chof, avisar_antes_cargar, avisar_salir_cargado,
pedir_muestra,descarga_bomba,prec_desc_bomba_cli,prec_desc_bomba_chof,lts_desc_bomba,  	planos_id,horas_espera,prec_horas_espera,observ_horas_espera)
VALUES ('$cod_albaran','$cod_empresa','$fecha','$cod_cliente','$nombre_cliente','$tipo_iva','$cod_descarga', '$poblacion','$observ_descarga','$horas_descarga', '$fecha_descarga', '$fecha_carga', '$viaje', '$franja', '$cod_tarjeta', '$mat1', '$cod_tractora', '$mat2', '$cod_terminal', '$nombre_terminal','$cod_operadora', '$descripcion','$cod_operario', '$cod_operario2', '$avisador', '$precio_chof', '$precio_cli','$cod_pedido','$cant_blue','$cant_sp95','$cant_sp98','$cant_go_a','$cant_go_a1','$cant_go_b','$cant_go_c','$cant_bio', '$suma_pedidos','$serv_blue', '$serv_sp95', '$serv_sp98', '$serv_go_a', '$serv_go_a1', '$serv_go_b', '$serv_go_c', '$serv_bio', '$suma_servidos',
'$cant_comp1', '$cant_comp2', '$cant_comp3', '$cant_comp4', '$cant_comp5', 	'$cant_comp6', 	'$cant_comp7', '$cant_comp8', '$prod_comp1', '$prod_comp2', '$prod_comp3', '$prod_comp4', '$prod_comp5', '$prod_comp6', '$prod_comp7', '$prod_comp8', '$observaciones', '$incidencias', '$a_cobrar', '$base',  '$cambiar_papel', '$observ_cambiar_papel', '$conectar_toma_terra', '$conectar_man_gasos', '$treure_mostres', '$doble_carga', '$prec_doble_carga_cli', '$prec_doble_carga_chof','$doble_descarga','$prec_doble_desc_cli','$prec_doble_desc_chof','$avisar_antes_cargar',
'$avisar_salir_cargado','$pedir_muestra','$descarga_bomba','$prec_desc_bomba_cli',
'$prec_desc_bomba_chof','$lts_desc_bomba','$planos_id','$horas_espera','$prec_horas_espera','$observ_horas_espera')";
...
$result_ord = mysql_query ($insertar_ord) or die ("<br /> No se ha insertado orden: ".mysql_error()."<br /> $insertar_ord <br />");

}

conectar_segu($base_datos);
$sql="UPDATE albaranes SET enviado = 'si', descargado='' WHERE cod_albaran='$cod_albaran'";
$result=mysql_query($sql, $link) or die ("<br /> No se ha modificado: ".mysql_error()."<br /> $sql <br />");

?>
<script type="text/javascript">
alert("Albarà <? echo $cod_albaran; ?> Traspassat");
</script>
<?

} // FIN DE: // SI TRASPASO ES SI: ENVIAMOS A LA TABLET
...
var traspaso=document.createElement("input");
traspaso.type="text"; traspaso.name="traspaso"; traspaso.id="traspaso";
document.forms["albaranes"].appendChild(traspaso);
traspaso.value='si';

document.forms["albaranes"].submit();
}
...
<form name="albaranes" id="albaranes" method="post" action="">
          ...
          <tr>
            ...
            <td align="center"><? if ($foto) { ?>
              <img src="/comun/imgs/eliminar2.gif" title="Eliminar" onClick="enlace(direccion_conta(''),'cod_albaran','<? echo $cod_albaran; ?>','eliminar','1','','','','','','','','','','','','','','','','');">&nbsp;<span class="vinculo" onClick="mostrar(event,'/<? echo $carpeta_data.'/fotos/'.$usuario_any.'/'.$foto; ?>','a','','','','','','','','','','','','','','','','','','','');"><? echo $foto; ?></span>
            <? } ?><? if ($foto1) { ?>
              <img src="/comun/imgs/eliminar2.gif" title="Eliminar" onClick="enlace(direccion_conta(''),'cod_albaran','<? echo $cod_albaran; ?>','eliminar','1','','','','','','','','','','','','','','','','');">&nbsp;<span class="vinculo" onClick="mostrar(event,'/<? echo $carpeta_data.'/fotos/'.$usuario_any.'/'.$foto1; ?>','a','','','','','','','','','','','','','','','','','','','');"><? echo $foto1; ?></span>
            <? } ?></td>
          ...
          <tr> 
            ...
            <td align="left"><input name="viaje" title="Tipo IVA" type="text" id="viaje" size="2" maxlength="2" value="<? echo "$viaje"; ?>"></td>
            <? if($descargado=='si'){
			...
			?>
            <td colspan="2" align="right">Confirmat 
            <input name="descargado" type="checkbox" id="descargado" value="1" <? echo "$seleccionado"; ?>></td>
...
<input name="mat2" title="mat2" type="text" id="mat2" size="10" maxlength="10" value="<? echo "$mat2"; ?>" readonly class="readonly"></td>
          ...
          <tr>
            ...
            <td colspan="5"><input name="cod_operario2" title="C&oacute;digo Conductor" type="text" id="cod_operario2" size="2" maxlength="2" value="<? echo "$cod_operario2"; ?>" onBlur="buscar_conta(event,'operarios',cod_operario2.value,'cod_operario2',cod_operario2.value,'fecha_descarga',fecha_descarga.value,'','','','','','','','','cod_operario2');">
              <img src="/comun/imgs/lupa.gif" onClick="abrir(event,'cod_operario2');">
          ...
          <tr> 
            ...
            <td colspan="5" align="left"><input name="cod_pedido" title="Comanda" type="text" id="cod_pedido" size="40" maxlength="40" value="<? echo "$cod_pedido"; ?>"></td>
...
?></td>
          ...
          <tr> 
			...
			<? } ?></td>
            <td width="54"><? if ($estado!="f") { ?> <div align="center"> <img src="/comun/imgs/enviar.png" name="Traspassar" id="Traspassar" title="Traspassar" value="Traspassar" onClick="enviar(event)" onMouseOver="window.top.focus();"><br/>Traspassar</div><? } ?></td>
            <td><? if ($estado!="f") { ?>
...
Eliminar</div>
			...
			<? } ?></td>
            <td colspan="2" align="center"><div align="center"><img src="/comun/imgs/nuevo.gif" title="Nou" onClick="location.href=direccion_conta('');"><br />
            Nou</div></td>
            <td><span class="texto_blanco_peq">
