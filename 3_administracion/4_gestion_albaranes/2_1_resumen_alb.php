...
<table>
<form name="resumen_alb" method="post" action="2_2_listado_alb.php">
  <tr class="titulo">
    <td colspan="4">Resum d'Albarans</td>
    </tr>
  <tr>
    <td width="10"></td>
    <td width="390"></td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right">Desc&agrave;rrega amb Bomba:</td>
    <td><select name="bomba">
      <option>TOTS</option>
      <option>SI</option>
      <option>NO</option>
    </select></td>
