...
$cod_cuenta_cobro=$_POST["cod_cuenta"];
$cod_cuenta_cobro=$cod_empresa.$cod_cuenta_cobro;
$cod_factura=$_POST["cod_factura"];
...
$existe_factura = sel_campo("COUNT(cod_factura)","","facturas","cod_factura = '$cod_factura' and cod_empresa = '$cod_empresa'");
...
$cod_cuenta_cli=$cod_empresa.'430'.sprintf("%04s",$cod_cliente);
...
(cod_empresa,cod_cobro,tabla,cod_cliente,nombre_cliente,cod_factura,fecha_cobro,hora_cobro,total_cobro,cod_cuenta_cli,cod_cuenta,desc_cobro,cod_cuenta_cobro)
VALUES
('$cod_empresa','$cod_cobro','$tabla','$cod_cliente','$nombre_cliente','$cod_factura','$fecha_cobro','$hora_cobro','$total_cobro','$cod_cuenta_cli','$cod_cuenta','$desc_cobro','$cod_cuenta_cobro')";
...
$cod_factura=sprintf("%06s", $cod_factura);
$cod_asiento_factura=sel_campo("cod_asiento","","asientos","txt_predef='VE' and cod_factura='$cod_factura'");
...
echo "<br/>ASTO. FACT: $cod_asiento_factura";
echo "<br/>select_lin_asi: $select_lin_asi";
exit();*/
...
if($pendiente[$i]=='pe')
	{
		...
		if($imp_venci[$i]==$total_cobro)
			{
				//echo "importe y cobros igual";
...
$total_cobro = sel_campo("total_cobro","","cobros","cod_cobro = '$cod_cobro' and cod_empresa = '$cod_empresa'");

$cod_cuenta_cli = sel_campo("cod_cuenta_cli","","cobros","cod_cobro = '$cod_cobro' and cod_empresa = '$cod_empresa'");
...
if($pendiente[$i]=='pa')
	{
		...
		if($imp_venci[$i]==$total_cobro)
			{
				//echo "importe y cobros igual: lo ponemos como pendiente";
...
$cod_cuenta_cobro=$fila["cod_cuenta_cobro"];
...
if (validado)
{
	...
	if (document.getElementById('tabla').value=='clientes' && document.getElementById('cod_cliente').value==0)
	{
...
?>
          ...
          <tr>
            ...
            <td colspan="8"><input name="cod_cuenta" type="text" id="cod_cuenta" title="C&oacute;digo Cuenta" size="8" maxlength="7" value="<? echo $cod_cuenta_cobro; ?>" onBlur="buscar_cuenta(event)">
          ...
          <tr>
            ...
            <td colspan="4"><input type="text" name="total_cobro" id="total_cobro" title="Total Cobro" size="13" maxlength="11" value="<? echo $total_cobro; ?>">
            &euro;</td>
            <td align="right">&nbsp;</td>
            <td colspan="3">&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr> 
            ...
            <td><strong>Cobro de Factura:</strong></td>
            <td><div align="right">
              <!---->
...
?>
          <tr bgcolor="<? echo $color; ?>">
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><span class="vinculo" onClick="mostrar(event,'03_08_recibo_cobro.php','cod_empresa','<? echo $cod_empresa; ?>','cod_cobro_ini','<? echo $cod_cobro; ?>','cod_cobro_fin','<? echo $cod_cobro; ?>','','','','','','','','','','','','','','');"><? echo sprintf("%04s", $cod_cobro); ?></span></td>
