...
/*
mod_sql("UPDATE facturas SET cod_remesa = '$cod_remesa' WHERE cod_empresa = '$cod_empresa' AND tabla = '$tabla'
AND cod_factura = '".$rem[$i]."'");
...
mod_sql("
INSERT INTO cobros
(cod_empresa,cod_cobro,tabla,cod_cliente,nombre_cliente,cod_factura,fecha_cobro,hora_cobro,total_cobro,cod_cuenta,desc_cobro,cod_remesa)
VALUES
('$cod_empresa','$cod_cobro','$tabla','".$lin[$ii]['cod']."','".addslashes($lin[$ii]['nom'])."','".$c[0]['cod_factura']."','$venci','".$hora_creacion."','".$lin[$ii]['cant']."','$cod_cuenta','".addslashes($concept)."','".$emp['cod_remesa']."')");
...
?>
    ...
    <td>&nbsp;</td>
          ...
          <tr> 
            ...
            <td><div align="right">Conc. Adicional 1:</div></td>
            <td colspan="2"><input type="text" name="concepto1" id="concepto1" title="Concepto" size="50" maxlength="40" value=""></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="2"><input type="hidden" name="cod_empresa" id="cod_empresa" value="<? echo $cod_empresa; ?>">
              Total Remesa:
              <input type="text" id="total_rem" size="13" maxlength="11" readonly="true" class="readonly">&nbsp;&euro;
            &nbsp;&nbsp;&nbsp;
Nº Dom.: <input type="text" id="num_dom" size="3" maxlength="3" readonly="true" class="readonly"></td>
            <td>&nbsp;</td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
...
AND facturas.cod_remesa = '' AND facturas.fac_total > 0 AND $tabla.num_cuenta != '' AND fecha_baja = 0 AND cod_factura NOT IN
	(
...
<input type="hidden" id="imp[<? echo $cod_factura; ?>]" value="<? echo $fac_total; ?>">
            ...
            <td><span class="vinculo" onClick="mostrar(event,'/<? echo $carpeta; ?>/3_entrada_datos/01_04_impr_recibos.php','cod_empresa','<? echo $cod_empresa; ?>','cod_factura_ini','<? echo $cod_factura; ?>','cod_factura_fin','<? echo $cod_factura; ?>','','','','','','','','','','','','','','');"><? echo $cod_factura; ?></span></td>
